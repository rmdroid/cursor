...
# Mittelstands-Realitätscheck

Kapitel 1 hat den Hebel benannt: Skills verdienen Geld, Chat oft nicht. Kapitel 2 hat die Sprache geklärt. Jetzt kommt die Betriebsfrage, die viele Teams überspringen und später teuer nachholen: **Lohnt sich das bei Ihnen — jetzt — und in welcher Form?** Nicht jedes Unternehmen braucht einen Agenten. Nicht jeder Freiberufler braucht drei. Manche Workflows verdienen Vereinfachung, manche einen Skill, manche bleiben bewusst manuell — und genau das ist oft die unternehmerisch bessere Antwort.

Zwischen Hype und Verweigerung liegt die Entscheidung, die Geld und Nerven spart: kleinste ausreichende Intervention, klarer Owner, Pilot vor Fläche. Wer hier ehrlich bleibt, baut in Teil II weniger eleganten Ballast — und kommt mit Vorhaben an, die Freigabe und Alltag überstehen.
...
Delivery will wöchentliche Statusberichte, Vertrieb will „Kundenupdates“, die GF will Ampeln. Drei Abteilungen, drei Prompts, drei Wahrheiten. Die Alternative: ein Skill „Status strukturieren“ mit festen Feldern — Stand, Risiko, Entscheidung nötig, nächster sichtbarer Meilenstein. Agent oder Assistent liefern den Rohbau; Owner je Mandat gibt kundenreif oder führungsreif frei. Dieselbe Fähigkeit, mehrere Leser — ohne drei Bots.

Abteilungsbots bleiben verlockend, weil Budgets, Tools und Ego an Abteilungen hängen. Der Realitätscheck sagt: **Budget darf abteilungsweise kommen, Architektur und Skill-Bibliothek nicht.** Sonst zahlen Sie mehrfach für denselben Statusbericht und niemand pflegt die gemeinsame Fähigkeit. Für IT heißt das gemeinsame Bibliothek, Identitäten und Logs bei fachlichen Ownern. Für GF heißt das Portfolio nach Wertstrom-Outcomes, nicht „jede Abteilung bekommt etwas“. Für Solo entfällt das Organigramm — der Wertstrom ist trotzdem da: Akquise → Angebot → Lieferung → Abschluss.

Ein zweiter Blick auf Übergaben lohnt sich immer. Dort liegen oft die teuersten Minuten: Warten, Nachfragen, Neuformulieren. Skills an Übergaben schlagen oft „einen Bot mitten in der Abteilung“, der lokal beeindruckt und global bricht.

## Freelancer: 1–3 fokussierte Agenten statt Zoo

Freiberufler und Solo-Setups haben keinen Konzernapparat, der den Zoo aufräumt. Jeder zusätzliche Agent kostet Pflege, Review-Zeit und kognitive Last. Die Realitätsregel für Solo lautet deshalb hart:

> Lieber **ein bis drei** fokussierte Agenten mit klaren Skills als fünf Experimente ohne Freigabe.
...
Chat bleibt erlaubt und nützlich. Der Realitätscheck trennt **Werkbank** und **Betrieb**. Wer das vermischt, bekommt Scheinprozesse: Jeder „macht das mit KI“, niemand kann denselben Schritt morgen mit derselben Qualität starten.

| | Reiner Chat | Skill / schmaler Agent |
|---|-------------|-------------------------|
| Zweck | Exploration, Formulieren, einmaliger Check | Wiederholbarer Outcome |
| Nachvollziehbarkeit | Verlauf privat, schwer übergebbar | Steckbrief, Version, Owner |
| Qualität | Tagesform und Erinnerung | Prüfkriterien, Freigabe |
| Skalierung | Kopieren und Hoffen | Bibliothek und Pilot |
| Risiko | Unsichtbare Gewohnheit wird „Prozess“ | Bewusste Grenzen und Stopps |

Chat ist richtig, wenn Sie etwas Neues klären, einen Entwurf anstoßen oder eine Idee verwerfen. Chat ist falsch als Betrieb, wenn derselbe Schritt nächste Woche wiederkommt und jemand anderes — oder Ihr zukünftiges Ich — dieselbe Qualität braucht.
...
Bevor jemand „wir bauen einen Agenten“ sagt, läuft die Entscheidung in Stufen. Das ist die **kleinste ausreichende Intervention** — vor der Methode in Kapitel 7, hier als Realitätsfilter. Ziel: so wenig bewegliche Teile wie nötig, so viel Prüfbarkeit wie nötig.

**Stufe 0 — Manuell lassen.** Wählen Sie das, wenn der Schritt selten ist, jede Instanz echte Einzelfall-Urteilskraft braucht, Freigabe und Haftung den ganzen Aufwand dominieren oder Vereinfachung noch nicht versucht wurde. Manuell ist keine Niederlage. Es ist oft die ehrlichste Antwort — besonders bei Strategie, Geld, Recht, Personal und finaler Außenfreigabe. Ein Betrieb, der diese Grenze hält, wirkt nicht rückständig. Er wirkt steuerbar.

**Stufe 1 — Vereinfachen, bevor Sie automatisieren.** Viele „KI-Projekte“ sind eigentlich Aufräumprojekte: eine Vorlage fehlt, die Ablage ist chaotisch, Zuständigkeit ist unklar. Vereinfachen heißt Pflichtfelder und Vorlage festziehen, überflüssige Schleifen streichen, Owner und Abnahmezeitpunkt benennen, doppelte Ablagen zusammenführen. Erst wenn der manuelle Ablauf **mit Vorlage** funktioniert, ist skill-reif denkbar. Wer Murks skillt, bekommt prüfbaren Murks — schneller. Diese Stufe spart im Mittelstand oft mehr als der erste Agent.

**Stufe 2 — Skillen (ein Outcome).** Skillen Sie, wenn Wiederholung oder Übergabekosten das Problem sind, Inputs/Outputs und Qualitätscheck benennbar sind und ein Mensch den Output abnehmen will und kann. Kein Agent nötig, wenn ein Skill am Arbeitsplatz oder in einem Assistenten reicht. Weniger bewegliche Teile, weniger Betriebslast. Für viele Mandate ist „ein harter Skill“ die ganze Lösung — und das ist ein Erfolg, kein Zwischenziel auf dem Weg zum Zoo.

**Stufe 3 — Agent bauen (schmal orchestrieren).** Bauen Sie einen Agenten nur, wenn mehrere Schritte oder Skills orchestriert werden müssen, Trigger und Ziel klar sind, Zugänge, Logs und Freigabe geklärt sind und ein Pilot mit Stop-Kriterium vereinbart ist. „Bauen“ heißt in diesem Buch: Betriebsmittel mit Grenzen — nicht Demo ohne Owner. Details zu Prozess→Agent: Kapitel 7; Messung ohne Fantasie-ROI: Kapitel 10. Wer Stufe 3 vor Stufe 1 wählt, automatisiert Unklarheit.

Der Kurzpfad für Entscheider bleibt fünf Fragen: Ist der Workflow in einem Satz klar? Wenn nein — dokumentieren oder vereinfachen. Reicht eine Vorlage ohne KI? Wenn ja — manuell mit Vorlage. Ein wiederholbarer Outcome mit Prüfung? Wenn ja — Skill. Mehrere Schritte orchestrieren, plus Owner und Freigabe? Dann schmaler Agent-Pilot. Zoo-Gefahr oder unklare Daten? Stopp, inventarisieren, kürzen, neu entscheiden.

### Beispielmuster G: Drei Wege, ein Schmerz
...
Die Fallen kehren in Kapitel 15 wieder; hier schon als Realitätsfilter: Bot pro Abteilung statt Outcome am Wertstrom; Chat als stiller Prozess ohne Owner und Version; Agent vor Vereinfachung; Skill-Friedhof ohne Pflege und Abschaltung; Freigabe vergessen, weil der Entwurf „schnell ging“; Solo-Überbau mit Plattform-Roadmap statt einem Workflow, der morgen wiederkommt. Gegen jede Falle hilft dieselbe Frage: **Was ist die kleinste ausreichende Intervention — und wer verantwortet sie?**

## Drei Realitäten — ein Filter

**Geschäftsführung** entscheidet Portfolio und Stopp: zwei bis drei Outcomes entlang des Wertstroms, keine flächendeckende Agenten-Einführung, keine Automatisierung ohne Owner. In jeder Demo zählen vier Fragen — Welcher Workflow? Welcher Skill? Wer gibt frei? Wann schalten wir ab?

**IT-Leitung** entscheidet Betriebsfähigkeit: Identitäten, Datenminimierung, Logging, Abschaltbarkeit, gemeinsame Skill-Bibliothek. „Nein“ zu Abteilungs-Zoos braucht einen freundlichen Alternativpfad — erlaubter schlanker Weg schlägt Verbot ohne Angebot.
...
**Titelvorschlag:** Entscheidungsbaum „bauen / skillen / manuell lassen“

**Inhalt (für Layout/Illustration):**

Startknoten: **„Wiederkehrender Schmerz / Auftrag?“**

1. **Nein / selten / hochindividuell** → Kasten **Manuell lassen** (Fußnote: Strategie, Geld, Recht, Personal, finale Freigabe immer Mensch).
2. **Ja, aber Ablauf unklar / chaotisch** → Kasten **Vereinfachen** (Vorlage, Owner, Pflichtfelder) → zurück zum Start oder weiter.
3. **Ablauf klar, ein Outcome, prüfbar** → Kasten **Skillen** (ein Skill, Steckbrief, Freigabe).
4. **Mehrere Schritte orchestrieren, Owner + Grenzen klar** → Kasten **Schmalen Agenten bauen** (Pilot, Logs, Stop-Kriterium).
5. Seitlicher Warnknoten: **Zoo-Gefahr / unklare Daten / kein Prüfer** → **Stopp & inventarisieren**.

**Beschriftung am Rand:** „Kleinste ausreichende Intervention zuerst.“

**Nicht zeigen:** ROI-Zahlen, Produktlogos als Empfehlung, Code/YAML, erfundene Kennzahlen.

---

### Was die Geschäftsführung entscheidet

Ob und welche Wertstrom-Outcomes überhaupt einen Agenten oder Skill verdienen; dass Abteilungs-Zoos keine Strategie sind; Stop- und Pilotregeln; welche Bereiche bewusst manuell bleiben.

### Was die IT-Leitung umsetzt

Checkliste und Entscheidungsbaum in den erlaubten Pfad übersetzen: Zugänge, Logs, Bibliothek, Abschaltung; Fachbereichen helfen, Skills vor Agenten zu wählen; Schatten-Experimente inventarisieren statt zu ignorieren.
