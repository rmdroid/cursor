...
**Hinweis:** Keine erfundenen Zahlen/Quellen. Skill-Code nicht im Buch. Beispiel-Skills werden fürs Buch spezifiziert (Steckbrief); **kein** Verweis auf private Autor-Repos (`rmdroid/skills` o. ä.). Öffentlicher Companion nur nach Hans-Freigabe. Großes Impressum: Hans. Früherer Cover-Kandidat „KI-Agenten & KI-Skills für den Mittelstand“ war Verwechslung, nicht Buchtitel.
