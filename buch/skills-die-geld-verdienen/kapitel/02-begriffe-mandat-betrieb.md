...
Steckbrief-Denke ohne Code: Name des Skills, Outcome in einem Satz, Inputs, Outputs, Qualitätscheck, Owner, was der Skill bewusst *nicht* darf. Mehr braucht die Fachseite für den Start. Die technische Form liegt im Repo (https://github.com/rmdroid/cursor/tree/main/buch/skills-die-geld-verdienen/skills); Muster u. a. Protokoll mit Entscheidungen (https://github.com/rmdroid/cursor/tree/main/buch/skills-die-geld-verdienen/skills/protokoll-entscheidungen/SKILL.md). Was der Skill nicht darf, führt direkt zur nächsten Linie, der Verantwortungsgrenze.
