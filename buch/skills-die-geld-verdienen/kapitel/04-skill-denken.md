---
title: "Skill-Denken: Bausteine statt Prompt-Chaos"
chapter: 4
status: entwurf
author: Mara
date: 2026-09-07
...
**Titelvorschlag:** Skill-Lebenszyklus (Idee → Test → Freigabe → Betrieb → Ablage)

**Inhalt (für Layout/Illustration):**

Kreis oder horizontale Kette mit fünf Stationen:

1. **Idee** — Schmerz/Outcome skizzieren; Stichworte: Wertstrom, ein Satz, Realitätscheck.  
2. **Test** — Steckbrief, Beispiel-Inputs, Checkliste, Review-Zeit beobachten.  
3. **Freigabe** — Owner + Betriebsmindest; Verbote/Datengrenzen; Geltungsbereich.  
4. **Betrieb** — Nutzung in Assistent/Agent/manuell; versionierte Nachschärfung; noch keine blinde Routine.  
5. **Ablage** — abschalten, markieren, aktive Bibliothek säubern.
