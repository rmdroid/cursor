...
- Status je Eintrag stammt aus den Vera-Briefings (Abruf 2026-09-07): **Verifiziert** | **Annahme** | **Unklar**.
- Vor Druck: deutsche konsolidierte Fassung der KI-Verordnung (CELEX 02024R1689-20260727) noch einmal lokal gegenlesen.
- Dieses Verzeichnis ist **kein Rechtsersatz** und keine anwaltliche Freigabe.
- Keine erfundenen Quellen; Einträge nur aus den genannten Vera-Briefings.

**Briefing-Grundlage:** `quellen-erste-funde.md`, `quellen-teil-i-kap01-03.md`, `quellen-kap06-eu-ai-act.md`, `spotcheck-kap06-2026-09-07.md`.
...
| Feld | Inhalt |
|------|--------|
| **Kurztitel** | IAB-Monitor Arbeitskräftebedarf 1/2026 |
| **Institution** | Institut für Arbeitsmarkt- und Berufsforschung (IAB) |
| **Datum** | 11. Juni 2026 |
| **URL** | https://iab-forum.de/iab-monitor-arbeitskraeftebedarf-4-2025-2/ |
| **Status** | Verifiziert |
...
| Feld | Inhalt |
|------|--------|
| **Kurztitel** | Zentrale Befunde zu aktuellen Arbeitsmarkt-Themen 2025 |
| **Institution** | IAB |
| **Datum** | Mai 2025 |
| **URL** | https://iab.de/wp-content/uploads/2025/05/Zentrale_Befunde_zu_aktuellen_Arbeitsmarktthemen_2025.pdf |
| **Status** | Verifiziert |
...
| Feld | Inhalt |
|------|--------|
| **Kurztitel** | IAB-Prognose 2025/2026; IAB-Kurzbericht kb2025-19 |
| **Institution** | IAB |
| **Datum** | 2025 (Kurzbericht); Presse zur Prognose 2025/2026 |
| **URL Presse** | https://iab.de/presseinfo/iab-prognose-fuer-2025-2026-arbeitsmarkt-profitiert-von-fiskalpaketen-wird-aber-durch-den-demografischen-wandel-gebremst/ |
| **URL PDF** | https://doku.iab.de/kurzber/2025/kb2025-19.pdf |
| **Status** | Verifiziert |
...
| Feld | Inhalt |
|------|--------|
| **Kurztitel** | KOFA Kompakt 5/2026: Fachkräftereport März 2026 |
| **Institution** | Institut der deutschen Wirtschaft (IW) / KOFA |
| **Datum** | 2026 (Report zu März 2026) |
| **URL** | https://www.iwkoeln.de/studien/jurek-tiedemann-gero-kunath-fachkraeftereport-maerz-2026-weniger-engpaesse-in-sozialberufen-mehr-bei-infrastruktur-und-verteidigung.html |
| **Status** | Verifiziert |
...
| Feld | Inhalt |
|------|--------|
| **Kurztitel** | ZEIT/dpa zu IW-Studie: Fachkräftelücke bis 2029 |
...
| Feld | Inhalt |
|------|--------|
| **Kurztitel** | Fachkräftestrategie der Bundesregierung |
| **Institution** | BMAS / Bundesregierung |
| **Datum** | Beschluss 12. Oktober 2022; Seite fortlaufend aktualisiert |
| **URL** | https://www.bmas.de/DE/Arbeit/Fachkraeftesicherung/Fachkraeftestrategie/fachkraeftestrategie-art.html |
| **Status** | Verifiziert |
...
| Feld | Inhalt |
|------|--------|
| **Kurztitel** | Gemeldete Stellen (Konjunkturindikator) |
| **Institution** | Statistisches Bundesamt (Destatis) |
| **Datum** | laufende Monatswerte (Abruf 2026-09-07) |
...
| Feld | Inhalt |
|------|--------|
| **Kurztitel** | Unternehmen mit Nutzung von KI nach Beschäftigtengrößenklassen |
| **Institution** | Statistisches Bundesamt |
| **Datum** | Stand 24. November 2025 (Berichtsjahr 2025) |
...
| Feld | Inhalt |
|------|--------|
| **Kurztitel** | Jedes fünfte Unternehmen nutzt künstliche Intelligenz (PM Nr. 444) |
...
| Feld | Inhalt |
|------|--------|
| **Kurztitel** | Künstliche Intelligenz im Mittelstand (Fokus Nr. 554); Fokus Nr. 533; PM 11.02.2026 |
| **Institution** | KfW Research |
| **Datum** | PM 11.02.2026; Fokus 554: 29.07.2026 |
| **URL PDF Fokus 554** | https://www.kfw.de/PDF/Download-Center/Konzernthemen/Research/PDF-Dokumente-Fokus-Volkswirtschaft/Fokus-2026/Fokus-Nr.-554-Juli-2026-KI_Mittelstand.pdf |
| **URL Presse (erste Funde)** | https://www.kfw.de/Über-die-KfW/Newsroom/Aktuelles/News-Details_902336.html |
| **URL PM** | https://www.kfw.de/%C3%9Cber-die-KfW/Newsroom/Aktuelles/Pressemitteilungen-Details_880896.html |
| **Status** | Verifiziert |
...
| Feld | Inhalt |
|------|--------|
| **Kurztitel** | Digitalisierung der Wirtschaft: Fast jedes Unternehmen beschäftigt sich mit KI |
| **Institution** | Bitkom Research / Bitkom e. V. |
| **Datum** | 11. März 2026 |
...
| Feld | Inhalt |
|------|--------|
| **Kurztitel** | KI-Index Mittelstand 2026 |
| **Institution** | Deutscher Mittelstands-Bund (DMB) mit Salesforce |
...
| Feld | Inhalt |
|------|--------|
| **Kurztitel** | Mittelstandsdefinition des IfM Bonn |
| **Institution** | Institut für Mittelstandsforschung Bonn |
...
| Feld | Inhalt |
|------|--------|
| **Kurztitel** | KMU-Definition der Europäischen Kommission |
| **Institution** | EU-Kommission; Darstellung IfM Bonn |
| **URL IfM** | https://www.ifm-bonn.org/definitionen/kmu-definition-der-eu-kommission |
| **URL Rechtsakt** | https://eur-lex.europa.eu/legal-content/DE/TXT/?uri=CELEX:32003H0361 |
| **Status** | Verifiziert |
...
| Feld | Inhalt |
|------|--------|
| **Kurztitel** | AI Agent Standards Initiative |
| **Institution** | NIST |
| **Datum** | Created 17.02.2026, Updated 14.08.2026 |
...
| Feld | Inhalt |
|------|--------|
| **Kurztitel** | AI RMF: Generative Artificial Intelligence Profile |
| **Institution** | NIST |
| **Datum** | Juli 2024 |
...
| Feld | Inhalt |
|------|--------|
| **Kurztitel** | VO (EU) 2024/1689 |
| **Institution** | Europäisches Parlament und Rat |
| **Datum** | 13.06.2024; ABl. L 2024/1689, 12.07.2024; Inkrafttreten 01.08.2024 |
| **URL** | https://eur-lex.europa.eu/eli/reg/2024/1689/oj?locale=de |
| **PDF (DE, OJ)** | https://eur-lex.europa.eu/legal-content/DE/TXT/PDF/?uri=OJ:L_202401689 |
| **Status** | Verifiziert |
...
| Feld | Inhalt |
|------|--------|
| **Kurztitel** | AI Act \| Shaping Europe’s digital future |
| **Institution** | Europäische Kommission |
| **Datum** | Last update laut Seite: 3 August 2026 (Abruf 07.09.2026) |
...
| Feld | Inhalt |
|------|--------|
| **Kurztitel** | AI Act Service Desk |
| **Institution** | Europäische Kommission / EU AI Office |
...
| Feld | Inhalt |
|------|--------|
| **Kurztitel** | Guidelines on transparency obligations for providers and deployers of AI systems |
| **Institution** | Europäische Kommission |
| **Datum** | Publication 20 July 2026 (Last update 31 July 2026) |
...
| Feld | Inhalt |
|------|--------|
| **Kurztitel** | Commission Guidelines on prohibited AI practices (AI Act) |
| **Institution** | Europäische Kommission |
| **Datum** | Publication 04 February 2025 |
...
| Feld | Inhalt |
|------|--------|
| **Kurztitel** | Umsetzungsleitfaden zur KI-Verordnung (Version 2.0) |
| **Institution** | Bitkom e. V. |
| **Datum** | Version 2.0 mit Klarstellungen bis Anfang Januar 2026 |
...
| **URL PDF** | https://digitalzentrum-kaiserslautern.de/wp-content/uploads/2026/01/06-2025-KI-Verordnung-Broschuere-WEB-FINAL.pdf |
...
| **Status** | Verifiziert (technischer Leitfaden, kein vollständiger AI-Act-Rechtsleitfaden) |
| **Kurzbeleg** | `(BSI QUAIDAL)` |

---

## D. Spot-Check Kap. 6 (Vera, 2026-09-07)

| Claim / Artikel | Ergebnis |
|-----------------|----------|
...
## E. Bewusst nicht als Primärfakt für Zahlen

| Quelle / Typ | Grund |
|--------------|--------|
| Statista-Themenpage Fachkräftemangel | Aggregator; oft Paywall/Sekundärzitate |
