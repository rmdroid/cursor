...
Leselogik: Zuerst die Elemente vom Ablauf bis zur Orchestrierung, dann Verantwortung und Freigabe, dann Betrieb und Steuerung. Alphabetisch finden Sie die Begriffe in der Übersichtstabelle am Ende.
...
**Agent.** Zielgerichtete Orchestrierung von Schritten und Skills mit Grenzen. Der Agent holt, verkettet, legt ab. Er ersetzt weder Owner noch Freigabe. Erst sinnvoll, wenn mehrere bewährte Skills orchestriert werden müssen und Zugänge, Logs und Stopp geklärt sind. Ein Agent ohne Skills ist Theater.
